  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: cn(
            "group toast group-[.toaster]:bg-white group-[.toaster]:text-gray-950 group-[.toaster]:rounded-2xl group-[.toaster]:border-gray-200 group-[.toaster]:shadow-sm dark:group-[.toaster]:bg-gray-950 dark:group-[.toaster]:text-gray-50 dark:group-[.toaster]:border-gray-800"
          ),
          description:
