...
export default function EditClassForm({ cd }: { cd: classType }) {
  ...
  const form = useForm<z.infer<typeof FormSchema>>({
    ...
    defaultValues: {
      ...
      class_location: cd.location!,
      class_end: parseISO(cd.class_end!),
      class_start: parseISO(cd.class_start!),
    },
  });
                  ...
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {field.value ? (
                        ...
                        <span>
                          {cd.class_end!
                            ? format(parseISO(cd.class_start!), 'PPP p')
                            : 'date not available'}
                        </span>
                      )}
                    </Button>
                ...
                <PopoverContent className='w-auto p-0'>
                  ...
                  <div className='p-3 border-t border-border'>
                    <TimePicker
                      ...
                      date={
                        !field.value ? parseISO(cd.class_start!) : field.value
                      }
                    />
                  </div>
                </PopoverContent>
                  ...
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {field.value ? (
                        ...
                        <span>
                          {cd.class_end!
                            ? format(parseISO(cd.class_end!), 'PPP p')
                            : 'date not available'}
                        </span>
                      )}
                    </Button>
                ...
                <PopoverContent className='w-auto p-0'>
                  ...
                  <div className='p-3 border-t border-border'>
                    <TimePicker
                      setDate={field.onChange}
                      date={
                        !field.value ? parseISO(cd.class_end!) : field.value
                      }
                    />
                  </div>
                </PopoverContent>
